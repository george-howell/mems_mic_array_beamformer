...
#Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {PDM_DIN[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[0]}]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {PDM_DIN[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[1]}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {PDM_DIN[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[2]}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {PDM_DIN[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[3]}]
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {PDM_DIN[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[4]}]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {PDM_DIN[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[5]}]
#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {PDM_DIN[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[6]}]
#Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {PDM_DIN[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[7]}]


##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports MOTOR_SIG_OUT[0]]
#    set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[0]]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports MOTOR_SIG_OUT[1]]
#    set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[1]]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports MOTOR_SIG_OUT[2]]
#    set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[2]]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports MOTOR_SIG_OUT[3]]
#    set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[3]]
#Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports MOTOR_SIG_OUT[0]]
set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[0]]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports MOTOR_SIG_OUT[1]]
set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[1]]
#Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports MOTOR_SIG_OUT[2]]
set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[2]]
#Sch name = JB10
set_property PACKAGE_PIN C16 [get_ports MOTOR_SIG_OUT[3]]
set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[3]]
...
set_property PACKAGE_PIN J3 [get_ports CLK_PDM_HD]
    set_property IOSTANDARD LVCMOS33 [get_ports CLK_PDM_HD]
##Sch name = XA2_P
#set_property PACKAGE_PIN L3 [get_ports MOTOR_SIG_OUT[1]]
#set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[1]]
##Sch name = XA3_P
#set_property PACKAGE_PIN M2 [get_ports MOTOR_SIG_OUT[2]]
#set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[2]]
##Sch name = XA4_P
#set_property PACKAGE_PIN N2 [get_ports MOTOR_SIG_OUT[3]]
#set_property IOSTANDARD LVCMOS33 [get_ports MOTOR_SIG_OUT[3]]
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports CLK_PDM_HD]
#set_property IOSTANDARD LVCMOS33 [get_ports CLK_PDM_HD]
##Sch name = XA2_N
#set_property PACKAGE_PIN M3 [get_ports PDM_DIN[5]]
#set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[5]}]
##Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports PDM_DIN[6]]
#set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[6]}]
##Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports PDM_DIN[7]]
#set_property IOSTANDARD LVCMOS33 [get_ports {PDM_DIN[7]}]
