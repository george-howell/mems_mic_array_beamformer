...
##Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports {CLK_1MHZ_HD}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {CLK_1MHZ_HD}]
##Sch name = JA8
#set_property PACKAGE_PIN K2 [get_ports {pdm_data_in_6}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {pdm_data_in_6}]
##Sch name = JA9
...
##Pmod Header JB
##Sch name = JB1
#set_property PACKAGE_PIN A14 [get_ports PDM_DIN_1]
#set_property IOSTANDARD LVCMOS33 [get_ports PDM_DIN_1]
##Sch name = JB2
#set_property PACKAGE_PIN A16 [get_ports PDM_DIN_2]
#set_property IOSTANDARD LVCMOS33 [get_ports PDM_DIN_2]
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports PDM_DIN_3]
#set_property IOSTANDARD LVCMOS33 [get_ports PDM_DIN_3]
##Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports PDM_DIN_4]
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {MOTOR_SIG_OUT[1]}]
##Sch name = XA3_N
#set_property PACKAGE_PIN M1 [get_ports {MOTOR_SIG_OUT[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {MOTOR_SIG_OUT[2]}]
##Sch name = XA4_N
#set_property PACKAGE_PIN N1 [get_ports {MOTOR_SIG_OUT[3]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {MOTOR_SIG_OUT[3]}]
